...
import { UserPlus, Shield, Lock, User, RefreshCcw } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">
            Join the{" "}
            <span className="font-semibold text-amber-700">Tribal Craft Marketplace</span>.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Select Role */}
          <div>
            <label className="block text-sm font-semibold text-amber-900 mb-1">Select Role</label>
          ...
          {/* Feedback Message */}
          {message && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center text-sm mt-3 font-medium text-amber-800">
              {message}
            </motion.div>
          )}
        </form>
